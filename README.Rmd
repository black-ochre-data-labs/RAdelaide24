...
| 12:30 | *Lunch* | | |
| 1:30  | Functions | [Functions](functions.html) | `r getTiming("functions_slides.qmd", 1.2)` |
|  | Using Rmarkdown | [RMarkdown](rmarkdown.html) | `r getTiming("rmarkdown_slides.qmd", 1.5)` |
| 3:00  | *Afternoon Tea* | | |
