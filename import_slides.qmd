...
# Loading Data Into R {background-color="#3d3d40"}
...
3. Extract to create a folder named `data`
...
1. In the `Environment Tab` click the broom &#129529;
...
# Data Frame Objects {background-color="#3d3d40"}
...
- This function has $\approx \infty$ *arguments* (`file`, `col_names` etc.)
