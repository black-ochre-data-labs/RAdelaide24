...
![](https://smped.github.io/motifTestR/reference/figures/favicon.png){.absolute top=300 right=70 width='120px'}

![](https://github.com/smped/ngsReports/blob/devel/man/figures/ngsReports.png?raw=true){.absolute top=50 right=70 width='120px'}

![](https://github.com/smped/extraChIPs/blob/devel/man/figures/extraChIPs.png?raw=true){.absolute top=180 right=0 width='120px'}



![](https://smped.github.io/transmogR/reference/figures/transmogR.png){.absolute top=420 right=0 width='120px'}
