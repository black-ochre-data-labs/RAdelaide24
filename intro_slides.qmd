...
::: {.notes}
- Discuss column sorting with Simon
:::
...
# R Studio { background-color="#3c3c44" background-image=https://www.rstudio.com/wp-content/uploads/2018/10/RStudio-Logo-Flat.png background-size="40%" background-opacity="0.5" background-position="75% 30%"}
