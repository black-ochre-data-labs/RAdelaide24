...
- mean occurence = average rate = $\lambda$
...
- Are there any other potetnail sources of variability?
...
- Using our design matrix, we will fit the model for all co-efficients in `X`
